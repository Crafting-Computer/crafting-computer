...
![S R Latch \(Initial State\)](../.gitbook/assets/image%20%2840%29.png)
...
![Nor Gate](../.gitbook/assets/image%20%2819%29.png)
...
![Top Nor Gate \(Initial State\)](../.gitbook/assets/image%20%287%29.png)
...
![S R Latch \(Set State\)](../.gitbook/assets/image%20%2814%29.png)
...
![Set State Step 1](../.gitbook/assets/image%20%2818%29.png)
...
![Set State Step 2](../.gitbook/assets/image%20%2817%29.png)

The output `0` of the bottom `nor` gate goes to the input of the top `nor` gate.

### Step 3

![Set State Step 3](../.gitbook/assets/image%20%2837%29.png)
...
![Set State Step 4](../.gitbook/assets/image%20%2810%29.png)
...
![Reset State](../.gitbook/assets/image%20%2822%29.png)
...
![Input and Output Names](../.gitbook/assets/image%20%2833%29.png)
...
![Reset State](../.gitbook/assets/image%20%2811%29.png)
...
![Read after Reset State \(Step 1\)](../.gitbook/assets/image%20%2834%29.png)

### Step 2

Pass down `0` to bottom `nor` gate.

![Read after Reset State \(Step 2\)](../.gitbook/assets/image%20%2813%29.png)

### Step 3

`0 nor 0` is `1`.

![Read after Reset State \(Step 3\)](../.gitbook/assets/image%20%2835%29.png)
...
![Read after Reset State \(Step 4\)](../.gitbook/assets/image%20%2839%29.png)
...
![Not Used State](../.gitbook/assets/image%20%2832%29.png)
...
![Not Used State \(Step 1\)](../.gitbook/assets/image%20%2820%29.png)

### Step 2

Pass `0` down to the bottom `nor` gate.

![Not Used State \(Step 2\)](../.gitbook/assets/image%20%2831%29.png)

### Step 3

`1 nor 0` is `0`.

![Not Used State \(Step 3\)](../.gitbook/assets/image%20%284%29.png)
...
![Not Used State \(Step 4\)](../.gitbook/assets/image%20%2841%29.png)
...
![Reading Not Used State \(Step 1\)](../.gitbook/assets/image%20%281%29.png)
...
![Reading Not Used State \(Step 3\)](../.gitbook/assets/image%20%2825%29.png)

### Step 4 \(Starting from Top\)

![Reading Not Used State \(Step 4\)](../.gitbook/assets/image%20%283%29.png)
...
![Reading Not Used State \(Step 1\)](../.gitbook/assets/image%20%2829%29.png)

### Step 2 \(Starting from Bottom\)

![Reading Not Used State \(Step 2\)](../.gitbook/assets/image%20%2828%29.png)

### Step 3 \(Starting from Bottom\)

![Reading Not Used State \(Step 3\)](../.gitbook/assets/image%20%288%29.png)

### Step 4 \(Starting from Bottom\)

![Reading Not Used State \(Step 4\)](../.gitbook/assets/image%20%2821%29.png)
